							...
							<div class="product-list">
								<div class="product">
									<div class="inner-product">
										...
										<p>The three of us are good friends. Teenagers, eleventh graders.
											Our appearance is the same as other high school students.</p>
										<!-- <a href="cart.html" class="button">Add to cart</a> -->
								...
								<div class="product">
									<div class="inner-product">
										...
										<small class="price">Rp20.000</small>
										<p>My Name is Raib. I’m 15 years old, a tenth-grader. 
											I have two cats: Whitey and Blacky.</p>
										<!-- <a href="cart.html" class="button">Add to cart</a> -->
										<a href="#" class="button muted">Read Details</a>
									</div>
								</div> <!-- .product -->
								...
								<div class="product">
									<div class="inner-product">
										...
										<small class="price">Rp20.000</small>
										<p>A few months after visiting the moon clan, Miss Selena finally appeared at school.
											He brings good news to adventurous children such as Raib, and Seli.</p>
										<!-- <a href="cart.html" class="button">Add to cart</a> -->
										<a href="#" class="button muted">Read Details</a>
									</div>
								</div> <!-- .product -->
								...
								<div class="product">
									<div class="inner-product">
										...
										<small class="price">Rp20.000</small>
										<p>Raib, Ali, dan Seli dirundung duka atas tewasnya Ily, sahabat mereka, pada pertarungan di Klan Matahari. 
											Tak hanya mereka, para kesatria Klan Bulan juga merasakan hal sama</p>
										<!-- <a href="cart.html" class="button">Add to cart</a> -->
										<a href="#" class="button muted">Read Details</a>
									</div>
								</div> <!-- .product -->
